...
export default function ServiceFormS323({ serviceId }: ServiceFormProps) {
      ...
      <form ref={formRef}>
        <CardHeader className="padding-card-header">
          <div className="text-header-card">
            สนใจบริการ ขอปรึกษาด้านวิศวกรรมและก่อสร้าง
          </div>
        </CardHeader>
        <PersonalInfoForm
          formData={formData}
        ...
        <CardBody className="padding-card-body">
          ...
          <ButtonGroup
            pathRedirect="service/b90ea95b-1a05-4aa0-4946-08dc8526f711"
