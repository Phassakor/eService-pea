...
export default function ServiceFormS302({ serviceId }: ServiceFormProps) {
      ...
      <form ref={formRef}>
        <CardHeader className="padding-card-header">
          <div className="text-header-card">
            สนใจรับบริการ ขอตรวจสอบและบำรุงรักษาสวิตซ์เกียร์
          </div>
        </CardHeader>
        <PersonalInfoForm
          formData={formData}
        ...
        <CardBody className="padding-card-body">
          ...
          <ButtonGroup
            pathRedirect="service/6af280a6-4d34-41b8-3e9e-08dc84fff09f"
