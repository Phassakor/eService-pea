...
export default function ServiceFormS321({ serviceId }: ServiceFormProps) {
      ...
      <form ref={formRef}>
        <CardHeader className="padding-card-header">
          <div className="text-header-card">
            สนใจรับบริการ ขอแก้กระแสไฟฟ้าขัดข้อง
          </div>
        </CardHeader>
        <PersonalInfoForm
          formData={formData}
        ...
        <CardBody className="padding-card-body">
          ...
          <ButtonGroup
            pathRedirect="service/969f3b40-ec07-434a-3ea4-08dc84fff09f"
