...
export default function ServiceFormS317({ serviceId }: ServiceFormProps) {
      ...
      <form ref={formRef}>
        <CardHeader className="padding-card-header">
          <div className="text-header-card">
            สนใจรับบริการ ขอติดตั้งมิเตอร์เปรียบเทียบ TOU
          </div>
        </CardHeader>
        <PersonalInfoForm
          formData={formData}
        ...
        <CardBody className="padding-card-body">
          <div className="gap-[1.75rem_1.875rem]">
            ...
            <TextareaForm
              label="รายละเอียดย่อของใบคำร้อง เช่น ขอซื้อมิเตอร์/อุปกรณ์ไฟฟ้า..."
          ...
          <ButtonGroup
            pathRedirect="service/2e333a7e-eb18-4e8b-493e-08dc8526f711"
