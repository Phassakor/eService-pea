...
export default function ServiceFormS308({ serviceId }: ServiceFormProps) {
      ...
      <form ref={formRef}>
        <CardHeader className="padding-card-header">
          <div className="text-header-card">
            สนใจบริการ ขอตรวจสอบระบบไฟฟ้า พร้อมออกใบรับรอง
          </div>
        </CardHeader>
        <PersonalInfoForm
          formData={formData}
        ...
        <CardBody className="padding-card-body">
          <div className="gap-[1.75rem_1.875rem]">
            <div className="grid md:grid-cols-2 sm:grid-cols gap-[1.75rem_1.875rem] mb-[30px]">
              ...
              />
              <InputForm
                label="ขนาดหม้อแปลงที่ติดตั้งรวม"
                placeholder="ขนาดหม้อแปลงรวมที่ลูกค้าติดตั้งใช้งาน (kVA)"
          ...
          <ButtonGroup
            pathRedirect="service/8bdafc25-66f5-4780-3ea1-08dc84fff09f"
