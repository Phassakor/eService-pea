...
export default function DownloadManual(props: any) {
                ...
                <div className="relative 2xl:mx-28 lg:p-2 p-0 2xl:mt-8 mt-2">
                    <div
                        ...
                        <div className="flex flex-col font-NotoSansThai">
                            <div
                                className="lg:text-[29px] text-[28px] text-[#8E0369] font-bold">ดาวน์โหลดคู่มือการงานใช้เว็บไซต์
                            </div>
                            ...
                            <div className="pt-8">
                                ...
                                <a href="https://drive.google.com/drive/search?q=%s"
                                   className="text-[#2796FD]"
                                >https://drive.google.com/drive/search?q=%s</a>
                            </div>
