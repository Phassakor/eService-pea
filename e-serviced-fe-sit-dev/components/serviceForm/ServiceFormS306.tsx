...
export default function ServiceFormS306({ serviceId }: ServiceFormProps) {
      ...
      <form ref={formRef}>
        <CardHeader className="padding-card-header">
          <div className="text-header-card">
            สนใจรับบริการขอแก้ไขและบำรุงรักษาระบบจำหน่าย
          </div>
        </CardHeader>
        <PersonalInfoForm
          formData={formData}
        ...
        <CardBody className="padding-card-body">
          ...
          <ButtonGroup
            pathRedirect="service/608d10d8-ce7f-4f16-3ea5-08dc84fff09f"
