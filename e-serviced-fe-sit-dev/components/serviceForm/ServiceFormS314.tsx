...
export default function ServiceFormS314({ serviceId }: ServiceFormProps) {
      ...
      <form ref={formRef}>
        <CardHeader className="padding-card-header">
          <div className="text-header-card">
            สนใจรับบริการ ขอเช่าฉนวนครอบสายไฟฟ้า
          </div>
        </CardHeader>
        <PersonalInfoForm
          formData={formData}
        ...
        <CardBody className="padding-card-body">
          ...
          <ButtonGroup
            pathRedirect="service/a1cd12ed-0635-43c1-4940-08dc8526f711"
