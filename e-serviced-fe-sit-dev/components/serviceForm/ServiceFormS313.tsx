...
export default function ServiceFormS313({ serviceId }: ServiceFormProps) {
      ...
      <form ref={formRef}>
        <CardHeader className="padding-card-header">
          <div className="text-header-card">
            สนใจรับบริการ ขอทดสอบหม้อแปลงไฟฟ้า
          </div>
        </CardHeader>
        ...
        <CardBody className="padding-card-body pb-2">
          ...
          <ButtonGroup
            pathRedirect="service/edff2def-0262-47fe-3e97-08dc84fff09f"
