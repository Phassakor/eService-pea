...
const Footer = () => {
  ...
  return (
    <>
      <div className="flex lg:flex-row flex-col lg:text-base text-xs justify-center lg:w-full mx-0 absolute p-6 2xl:gap-48 lg:gap-12 2xl:mt-8 lg:mt-2 mt-4 font-NotoSansThai text-white">
        <div className="section1">
          <div className="font-semibold text-[18px]">
            {data?.address_name}
          </div>
          <div className="flex gap-x-5 lg:mt-4 my-4">
            {data?.x && (
              <div>
                <Link href={`${data.x}`}>
        ...
        <div className="section2">
          <div className="font-semibold text-[18px] lg:mt-0 mt-2">
            ติดต่อเรา
          </div>
          <div className="flex flex-col gap-x-2 gap-y-2 font-light lg:text-[14px] text-[16px] lg:mt-2 mt-4">
            <div className="flex">
        ...
        <div className="section3">
          <div className="invisible">No Header</div>
            <div className="flex flex-col lg:ml-0 ml-4 gap-y-1 font-light lg:text-[14px] text-[16px] lg:mt-0 mt-2">
                <a href='/terms-and-conditions'>Terms and Conditions</a>
                <a href='/privacy-policy'>Privacy Data Policy</a>
                <a href='/download-manual'>ดาวน์โหลดคู่มือการใช้เว็บไซต์</a>
            </div>
        </div>
      </div>
      ...
      <Image
        ...
        height={0}
        sizes="100vw"
        className="lg:hidden block md:h-[460px] h-[430px]"
